...
$(document).ready(function(){
   ...
   $('#divRss2X').FeedEk({
   FeedUrl : 'http://www.cinemablend.com/rss.php?v=1',
   MaxCount : 25,
   ShowDesc : true,
   ShowPubDate: true
  });
...
echo "
<a href=\"http://www.cinemablend.com/\" target=\"hrnew\"><img style=\" margin-left:0px; margin-top:2px; height:50px; margin-bottom:0px;\" src=\"includes/images/cinemablend.png\"></a>
