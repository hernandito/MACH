...
$(document).ready(function(){
   ...
   $('#divRss2X').FeedEk({
   FeedUrl : 'http://feeds.feedburner.com/firstshowing?v=1',
   MaxCount : 35,
   ShowDesc : true,
   ShowPubDate: true
  });
...
echo "
<a href=\"http://www.firstshowing.net/\" target=\"hrnew\"><img style=\" margin-left:0px; margin-top:2px; height: 60px; margin-bottom:0px;\" src=\"includes/images/firstshowing.jpg\"></a>
