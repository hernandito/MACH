...
$(document).ready(function(){
   ...
   $('#divRss2X').FeedEk({
   FeedUrl : 'http://page2rss.com/rss/c97d3c997d11f020b511bf50051afc08?v=1',
   MaxCount : 35,
   ShowDesc : true,
   ShowPubDate: true
  });
...
echo "
<a href=\"http://www.firstshowing.net/\" target=\"hrnew\"><img style=\" margin-left:0px; margin-top:2px; height: 60px; margin-bottom:0px;\" src=\"includes/images/hollywoodreporter.jpg\"></a>
