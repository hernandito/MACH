...
$myurl0 = "http://{$xbmcusername2}:{$xbmcpassword2}@{$xbmcIP2}:{$xbmcport2}/jsonrpc?request={%20%22jsonrpc%22:%20%222.0%22,%20%22method%22:%20%22Player.GetActivePlayers%22,%20%22id%22:%20%22mybash%22}";
...
/* Check to see if this is playing a video and then parse the info for the video. */
	...
	if($hrisplaying == "video"):
		...
		/* It checked for VIDEO, parsing video info */
			$myurl = "http://{$xbmcusername2}:{$xbmcpassword2}@{$xbmcIP2}:{$xbmcport2}/jsonrpc?request={%20%22jsonrpc%22:%20%222.0%22,%20%22method%22:%20%20%22Player.GetItem%22,%20%22params%22:%20{%20%22playerid%22:%201,%20%22properties%22:%20[%22showtitle%22,%20%22thumbnail%22,%20%22art%22]%20},%20%22id%22:%20%22mybash%22}%22";
			...
			echo "
				...
				echo "			<br><br>
								...
								<a class='classpanel' href=\"#\" id='pauseplayliving' style='font-family: Verdana, Geneva, sans-serif; font-size: 18px; font-style: normal; font-weight: bold; margin: 0px; padding: 12px; color: #999999;' > Play Pause </a>
								
								<a class='classpanel' href=\"#\" id='playstopliving' style='font-family: Verdana, Geneva, sans-serif; font-size: 18px; font-style: normal; font-weight: bold; margin: 0px; padding: 12px; color: #999999;' > Stop </a><br>
								
									<div style=\"font-size: 12px; color:#999999; font-weight: normal;\" id=\"div3a\">
										<br>{$hrplaystatetext}
									</div>						
								</div>
							</div>
	...
	elseif($hrisplaying == "audio"):    /* It checked for Music, parsing Album info */
		...
		echo "Nothing is playing. Watch something...!!</div>";
	endif;
