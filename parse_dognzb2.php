...
function dognzbRefresh(){
$("#dogdiv").load("blank.php");
$("#dogdiv").load("parse_dognzb2.php");
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" >
					<tr valign="top">  					
						<td width=30px bgcolor=white >	
							...
							<!---->
							<br>
							<center><a  href="#" title="Refresh" onClick="dognzbRefresh()" ><img src="includes/images/refresh.png"></a></center>
								...
								$myimdblink = "<a href='http://imdb.com/title/tt{$myimdb}' target='_new'><img src='includes/images/minimdb.png' style='padding-bottom:-4px; margin-bottom: -5px; margin-left:-3px;'></a>";
								  ...
								  $B=array();
								   foreach ( $descriptions as $description_node ) {
									...
									."<img class=\"tooltipx\" height=\"168\" src=\"{$img}\"  style=\" max-width: 112px;\"  title=\"<img src='{$img}' height=170 align=right id=postersingle2 class=postersingle2 style='margin-left:5px; '>{$mytrimtitle} <font id=bubble class=bubble>";
									foreach($A as$a){
											if($B[$a]) {
												$B[$a]=str_replace('"',"'",$B[$a]) ;	
									...
									$itemCnt.="<br><br><br><br><br><br><br><br><br><br><br><br><hr>
