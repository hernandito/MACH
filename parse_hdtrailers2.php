...
if($watchURL720p!="") { 
echo "<a href=\"{$watchURL720p}\" class=\"iframe\"><img  class=\"tooltip\" src=\"{$myposter}\" height=\"164\" style=\"margin: 2px; border: 1px solid #4D4D4D;\" title='<img src=\"{$myposter}\" width=120 align=right id=postersingle2 class=postersingle2 style=\"margin-left:5px;\">{$mytitle}</b></font><br><br><font id=bubble class=bubble>{$mydesc}<br></font>'></a>";
} elseif ($watchURL1080p!="") { 
echo "<a href=\"{$watchURL1080p}\" class=\"iframe\"><img  class=\"tooltip\" src=\"{$myposter}\" height=\"164\" style=\"margin: 2px; border: 1px solid #4D4D4D;\" title='<img src=\"{$myposter}\" width=120 align=right id=postersingle2 class=postersingle2 style=\"margin-left:5px;\">{$mytitle}</b></font><br><br><font id=bubble class=bubble>{$mydesc}<br></font>'></a>";
}
