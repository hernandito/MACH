...
$("#nzbtvdiv").load("parse_nzbsdotorg.php");
...
<SCRIPT LANGUAGE="JavaScript">
    function getTrailersnzbtv(movieid)
    {
        ...
        $("#mytrailersnzbtv").load("trailersearch.php",$("#nzbtv" + movieid).serialize()); 
				...
				<table width="100%" border="0" cellspacing="3" cellpadding="0" >
					<tr valign="top">  					
						<td width=30px bgcolor=white >	
							<?php
								echo "<a href={$NzbTVLandingPage} rel='ajaxpanel'><img style=\"margin-top:5px; margin-left:3px;\" src=\"{$NzbTVLogoImage}\" >";
							?>
						</td>			
						<td>
							<div id='nzbtvdiv'>		
							<?php
								...
								$xml = simplexml_load_file($NzbTVRSS);
								...
								foreach ( $items as $item) {
									...
									."<img class=\"tooltipx\" height=\"{$MovieIconSizeNzbtv}\" src=\"{$img}\"  title=\"
									...
									$itemCnt.="<br>
														...
														<form action='JavaScript:getTrailersnzbtv($myimdb)' method='POST' id='nzbtv{$myimdb}' >
								...
								{$myimdblink}<div id='mytrailersnzbtv'></div>									
