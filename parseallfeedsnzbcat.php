...
//########################################################################################################################
	...
	$xml = simplexml_load_file($NZBcatRSS);

	if ($xml != "") { 		
	
			$sql = "DELETE FROM nzbcat";
...
/////////////////////////////////////////////////////////////////////////////////////////////////								  
					...
					//	echo $itemdetails;
						...
						$query = "INSERT INTO nzbcat (timestamp, mytrimtitle, myimdbtt, myimdb, myfulltitle, mylink, img, itemdetails, guid) VALUES ('$timestamp', '$mytrimtitle', '$myimdbtt', '$myimdb', '$myfulltitle', '$mylink', '$img', '$itemdetails', '$myguid')";
	...
	} else { echo "NZBcat Feed Not Available<br>"; }
