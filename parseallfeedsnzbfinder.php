...
//########################################################################################################################
	...
	$xml = simplexml_load_file($NZBfinderRSS);

	if ($xml != "") { 		
	
			$sql = "DELETE FROM nzbfinder";
...
/////////////////////////////////////////////////////////////////////////////////////////////////								  
					...
					//	echo $itemdetails;
						...
						$query = "INSERT INTO nzbfinder (timestamp, mytrimtitle, myimdbtt, myimdb, myfulltitle, mylink, img, itemdetails, guid) VALUES ('$timestamp', '$mytrimtitle', '$myimdbtt', '$myimdb', '$myfulltitle', '$mylink', '$img', '$itemdetails', '$myguid')";
	...
	} else { echo "nzbfinder Feed Not Available<br>"; }
