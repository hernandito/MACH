			...
			$timestamp = date('Y/m/d H:i:s');
				...
				foreach ( $items as $item) {
					...
					//	echo $itemdetails; 
						...
						$query = "INSERT INTO nzbsdotorg (timestamp, mytrimtitle, myimdbtt, myimdb, myfulltitle, mylink, img, itemdetails, guid) VALUES ('$timestamp', '$mytrimtitle', '$myimdbtt', '$myimdb', '$myfulltitle', '$mylink', '$img', '$itemdetails', '$myguid')";
