	...
	if ($xml != "") { 		
			...
			$timestamp = date('Y/m/d H:i:s');
				...
				foreach ( $items as $item) {
						...
						$myguid = $item->guid;
						$myguid = str_replace("https://nzbtv.net/details/","",$myguid);
...
/////////////////////////////////////////////////////////////////////////////////////////////////								  
					...
					//	echo $itemdetails;
						...
						$query = "INSERT INTO nzbtv (timestamp, mytrimtitle, myimdbtt, myimdb, myfulltitle, mylink, img, itemdetails, guid) VALUES ('$timestamp', '$mytrimtitle', '$myimdbtt', '$myimdb', '$myfulltitle', '$mylink', '$img', '$itemdetails', '$myguid')";
	...
	} else { echo "NZB.tv Feed Not Available<br>"; }
