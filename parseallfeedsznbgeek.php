...
//########################################################################################################################
//
//		Begin Parsing NZBNDX
//
//########################################################################################################################

	$xml = simplexml_load_file("https://api.nzbgeek.info/rss?t=2040&num=28&r=8b1ff0a5489439bfc373a41c6c026c23");

	if ($xml != "") { 		
	
			$sql = "DELETE FROM nzbndx";
			...
			$timestamp = date('Y/m/d H:i:s');
				...
				foreach ( $items as $item) {
						...
						$myguid = $item->guid;
						$myguid = str_replace("https://www.nzbndx.com/details/","",$myguid);
						...
						$A=array("Year","Size","Plot", "Rating");//,"Director","Actors"
						$B=array();
						 foreach ( $descriptions as $description_node ) {
							...
							$img=$imgs[0];$img=(array)$img[src];$img=$img[0];if(strlen($img)<23) $img="includes/images/noposter.jpg";								 	
...
/////////////////////////////////////////////////////////////////////////////////////////////////								  
					...
					//	echo $itemdetails;
						...
						$query = "INSERT INTO nzbndx (timestamp, mytrimtitle, myimdbtt, myimdb, myfulltitle, mylink, img, itemdetails, guid) VALUES ('$timestamp', '$mytrimtitle', '$myimdbtt', '$myimdb', '$myfulltitle', '$mylink', '$img', '$itemdetails', '$myguid')";
	...
	} else { echo "NZBNDX Feed Not Available<br>"; }
