...
$myurl = "http://api.rottentomatoes.com/api/public/v1.0/lists/dvds/new_releases.json?apikey={$RottenTomatoesAPI}&page_limit=44";
...
$totality = count($result);
	...
	for ($i = 0; $i <$totality; $i++) {
		...
		echo "<div id='postersingle' class='postersingle'><a class=\"tooltip4\" rel=\"ajaxpanel\" href=\"{$hrlinks}\" title= '
		<img src=\"{$hrthumbnail}\" width=120 align=right id=postersingle2 class=postersingle2 style=\"margin-left:5px;\"> 
					{$hrmovietitle}<br><br>	
					...
					</font>	' ><img src=\"{$hrthumbnail}\" height=\"90\" style=\"max-width:130px;\"></a><br>
