...
require 'config.php';
	...
	echo "<a class=tooltip2 href=\"#\" onclick=\"return false;\" 
							...
							echo "</font></table><br>' ><img style=\"padding-right:0px; padding-left:0px; border:1px solid #4D4D4D;\"src=\"{$src}\" width=68></a>";
