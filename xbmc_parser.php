...
$myurl = "http://{$xbmcusername1}:{$xbmcpassword1}@{$xbmcIP1}:{$xbmcport1}/jsonrpc?request={%22jsonrpc%22:%20%222.0%22,%20%22method%22:%20%22VideoLibrary.GetRecentlyAddedMovies%22,%20%22params%22:%20{%22limits%22:%20{%20%22start%22%20:%200,%20%22end%22:%2012%20},%20%22properties%22%20:%20[%22title%22,%20%22mpaa%22,%20%22thumbnail%22,%20%22rating%22,%20%22year%22,%20%22plot%22]%20%20},%20%22id%22:%20%22libMovies%22}";
	...
	for ($i = 0; $i <= 5; $i++) {
		...
		</table>' ><img style=\"padding-right:0px; border: 1px solid #4D4D4D;  \"src=\"{$src}\" width=68></a>";
	...
	echo "<div style=\"	font-family: Verdana, Geneva, sans-serif; font-size: 10px; font-style: normal; font-weight: bold; color: #FC0; text-decoration: none; margin-left: 1px;\"><br>Recent TV Shows:</div>";
	...
	for ($i = 0; $i <= 6; $i++) {
		...
		echo "<li >" .substr($result[$i]['showtitle'],0,28);
		echo "<font color=#E0CD83> - s".sprintf("%02s",$result[$i]['season'])."e".sprintf("%02s", $result[$i]['episode']). "</font></li>";
	}
