...
//iPad Detected
	...
	for ($i = 0; $i <= $countememax; $i++) {
		...
		style=\" padding-right:0px; border: 1px solid #4D4D4D; height: 127px \" src=\"{$src}\" ";
	...
	echo "<div id='moverfloew'>";
		for ($i = 16; $i <= $numberrecentmvies -1; $i++) {
		$hrmovietitle = $result[$i]['label'];
		$hrmovietitle =  str_replace('"',"'",$hrmovietitle) ;	
		$hrmovietitle = htmlentities($hrmovietitle, ENT_QUOTES, 'UTF-8');
		...
		</table>' ><img style=\" padding-right:0px; border: 1px solid #4D4D4D; height: 127px \" src=\"{$src}\" width=85  ></a>";
